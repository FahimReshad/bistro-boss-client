...
const Banner = () => {
  ...
  return (
    <>
      <div
        className="w-full h-60 sm:h-96 md:h-[540px] lg:h-[740px] flex flex-col items-center justify-center gap-5 lg:gap-10 bg-cover bg-center before:absolute before:bg-black/50 before:inset-0 transform duration-1000 ease-linear object-cover"
